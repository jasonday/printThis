...
(function(window) {
    ...
    function printThis(selector, options) {
        ...
        setTimeout(() => {
            ...
            if (settings.doctypeString) {
                doc.open();
                doc.write(settings.doctypeString);
                doc.close();
            }
            ...
            elements.forEach(element => {
                ...
                if (settings.removeScripts) {
                    content.querySelectorAll('script').forEach(.remove());
                }
            ...
            setTimeout(() => {
                ...
                // Fix for browsers supporting execCommand("print") but not exposing it to the contentWindow
